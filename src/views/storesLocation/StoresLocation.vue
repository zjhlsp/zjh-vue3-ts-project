...
<template>
  <div>
    ...
    <!-- 新增和修改弹窗 -->
    <el-dialog
      v-model="state.storeFormDialogVisible"
      :title="state.formTitle"
    >
      <el-form
        ref="refForm"
        :model="state.storeFormData"
        :rules="rules"
        label-width="100px"
      >
        <el-form-item
        ...
        >
          <el-input
            v-model="state.storeFormData.storeName"
            placeholder="请输入门店名"
          />
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            v-model="state.storeFormData.storeCity"
            placeholder="请输入城市名"
          />
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            v-model="state.storeFormData.storeLongitude"
            placeholder="请输入经度"
          />
        </el-form-item>
        <el-form-item
        ...
        >
          <el-input
            v-model="state.storeFormData.storeLatitude"
            placeholder="请输入纬度"
          />
        </el-form-item>
        <el-form-item>
...
import type { storeFullType } from './storeType';
// 引入全局变量
...
const toDelete = (storeId: number) => {
  ElMessageBox.confirm('提示!对应的商品也会一并删除，确定删除吗？').then(() => {
