    ...
    <div style="text-align: left; margin: 5px 10px">
      ...
      >
        ...
        <el-form-item label="订单号选择">
          <el-input
            v-model="state.orderObj.orderNo"
            placeholder="请输入订单号"
          />
        </el-form-item>
        <!-- 门店选择 -->
        <el-form-item label="门店选择">
          <el-select
            v-model="state.orderObj.storeId"
            placeholder="请选择你要查询的门店"
          >
            <el-option
        ...
        <el-form-item label="订单状态选择">
          <el-select
            v-model="state.orderObj.orderStatus"
            placeholder="请选择你要查询的订单状态"
          >
            <el-option
        ...
        <el-form-item label="订单开始时间选择">
          <el-date-picker
            v-model="state.orderObj.createTime" 
        ...
        <el-form-item label="订单结束时间选择">
          <el-date-picker
            v-model="state.orderObj.finishTime" 
            format="YYYY/MM/DD hh:mm:ss"
            value-format="YYYY-MM-DD hh:mm:ss"
            type="datetime"
            placeholder="订单结束时间"
    ...
    <div>
      ...
      <div style="margin: 0px 10px;text-align: left;">
        ...
        <el-row style="float: right">
          <el-pagination
            v-model:current-page="state.searchParams.pageNo"
